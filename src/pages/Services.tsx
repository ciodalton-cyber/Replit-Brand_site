import { useState } from "react";
  ...
  import RedNoteModal from "../components/RedNoteModal";
  ...
  export default function Services() {
    ...
    return (
      <>
            ...
            >
              ...
              >
                ...
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                  <rect x="3" y="3" width="18" height="18" rx="4" fill="#FF2442"/>
                  <text x="12" y="16" textAnchor="middle" fill="white" fontSize="10" fontWeight="bold" fontFamily="sans-serif">小</text>
                </svg>
                小红书 RedNote
              </button>
        ...
        {rednoteOpen && <RedNoteModal onClose={() => setRednoteOpen(false)} />}
      </>
    );
  }
